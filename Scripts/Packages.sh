...
# UPDATE_PACKAGE "app-argon-config" "jerrykuku/luci-app-argon-config" "master"
...
UPDATE_VERSION "sing-box" "1.9.0-rc.3" "68059f7128ab6812379c4159771d1eea323f0e89daf4c719ba1db12eb8e90d65"
